...
public class CabinetController {
    ...
    // ============ DASHBOARD ADMIN STATS ENDPOINTS ============
    ...
    /**
     * Statistiques d'un cabinet spécifique (pour Admin de cabinet)
     */
    @GetMapping("/stats/cabinet/{cabinetId}")
    public ResponseEntity<CabinetResponse> getCabinetStats(@PathVariable Long cabinetId) {
        return ResponseEntity.ok(service.getCabinetStats(cabinetId));
    }
}